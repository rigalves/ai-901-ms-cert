...
| 2 | [Get started with generative AI and agents in Azure](https://learn.microsoft.com/en-us/training/modules/get-started-with-generative-ai-and-agents/) | Model selection/deployment, prompts, chat client, agent portal/client | [`docs/topics/generative-ai-prompts-model-configuration.md`](docs/topics/generative-ai-prompts-model-configuration.md) for model selection, deployment/configuration, prompts, and portal workflow; [`docs/topics/agentic-ai-single-agent-solutions.md`](docs/topics/agentic-ai-single-agent-solutions.md) for agent concepts, portal workflow, and testing; [`docs/topics/foundry-sdk-chat-agent-clients.md`](docs/topics/foundry-sdk-chat-agent-clients.md) for chat and agent client workflows; [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) for cross-cutting Python recognition | [Generative/prompt gap complete](research/gaps/generative-ai-prompts-model-configuration.md); [agent gap complete](research/gaps/agentic-ai-single-agent-solutions.md); [Foundry SDK client gap complete](research/gaps/foundry-sdk-chat-agent-clients.md); [cross-cutting Python gap complete](research/gaps/python-sdk-recognition-csharp-developer.md) | **Not started** |
| 3 | [Get started with text analysis in Azure](https://learn.microsoft.com/en-us/training/modules/get-started-text-analysis-azure/) | Foundry text analysis, Azure Language, Python client, agent tool | [`docs/topics/text-analysis-azure-language.md`](docs/topics/text-analysis-azure-language.md); [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) for cross-cutting Python recognition | [Text-analysis gap complete](research/gaps/text-analysis-azure-language.md); [cross-cutting Python gap complete](research/gaps/python-sdk-recognition-csharp-developer.md) | **Not started** |
| 4 | [Get started with speech in Azure](https://learn.microsoft.com/en-us/training/modules/get-started-speech-azure/) | Speech SDK, recognition, synthesis, Voice Live | [`docs/topics/speech.md`](docs/topics/speech.md); [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) for callbacks and SDK completion patterns | [Speech gap complete](research/gaps/speech-recognition-synthesis.md); [cross-cutting Python gap complete](research/gaps/python-sdk-recognition-csharp-developer.md) | **Not started** |
| 5 | [Get started with computer vision in Azure](https://learn.microsoft.com/en-us/training/modules/get-started-vision-azure/) | Multimodal visual input, image/video generation | [`docs/topics/computer-vision.md`](docs/topics/computer-vision.md); [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) for nested payload and image-output syntax | [Vision gap complete](research/gaps/computer-vision-image-generation.md); [cross-cutting Python gap complete](research/gaps/python-sdk-recognition-csharp-developer.md) | **Not started** |
| 6 | [Get started with AI-powered information extraction in Azure](https://learn.microsoft.com/en-us/training/modules/get-started-information-extraction/) | Content Understanding for documents, images, audio, and video | [`docs/topics/information-extraction.md`](docs/topics/information-extraction.md); [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) for pollers, typed results, and async recognition | [Extraction gap complete](research/gaps/information-extraction-content-understanding.md); [cross-cutting Python gap complete](research/gaps/python-sdk-recognition-csharp-developer.md) | **Not started** |
...
- [**Foundry resources, projects, deployments, endpoints, and authentication — complete**](research/gaps/foundry-resources-projects-endpoints-authentication.md)
- [**Foundry SDK chat and agent clients — complete**](research/gaps/foundry-sdk-chat-agent-clients.md)
- [**Python SDK recognition for a C# developer — complete and cross-cutting**](research/gaps/python-sdk-recognition-csharp-developer.md)
...
| Create a lightweight chat client with the Foundry SDK | [Using a generative AI model](https://learn.microsoft.com/en-us/training/modules/get-started-with-generative-ai-and-agents/3-using-generative-ai-models) | [`docs/topics/foundry-sdk-chat-agent-clients.md`](docs/topics/foundry-sdk-chat-agent-clients.md) includes the current model-client workflow, state options, and client-specific practice; [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) provides the cross-cutting syntax map |
...
| Create a lightweight client application for an agent | [Creating an agent](https://learn.microsoft.com/en-us/training/modules/get-started-with-generative-ai-and-agents/4-creating-an-agent) | [`docs/topics/foundry-sdk-chat-agent-clients.md`](docs/topics/foundry-sdk-chat-agent-clients.md) includes persisted-agent invocation and conversation handling; [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) provides the cross-cutting syntax map |
...
- [**Speech recognition and synthesis — complete**](research/gaps/speech-recognition-synthesis.md)
- [**Python SDK recognition for a C# developer — complete and cross-cutting**](research/gaps/python-sdk-recognition-csharp-developer.md)
...
| Build a lightweight application with Azure Speech in Foundry Tools | [Speech recognition](https://learn.microsoft.com/en-us/training/modules/get-started-speech-azure/2-speech-recognition) · [Speech synthesis](https://learn.microsoft.com/en-us/training/modules/get-started-speech-azure/3-speech-synthesis) · [Exercise](https://learn.microsoft.com/en-us/training/modules/get-started-speech-azure/5-exercise) | [`docs/topics/speech.md`](docs/topics/speech.md) includes minimal Python flows and C# mappings; [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) distinguishes callbacks, immediate results, and Speech SDK futures |
...
- [**Computer vision, OCR, multimodal input, and image generation — complete**](research/gaps/computer-vision-image-generation.md)
- [**Python SDK recognition for a C# developer — complete and cross-cutting**](research/gaps/python-sdk-recognition-csharp-developer.md)

| Official subtopic | Official study links | Prepared asset |
|---|---|---|
| Interpret visual input with a deployed multimodal model | [Multimodal image analysis](https://learn.microsoft.com/en-us/training/modules/get-started-vision-azure/2-vision-enabled-models) | [`docs/topics/computer-vision.md`](docs/topics/computer-vision.md); [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) explains nested list-and-dictionary payloads |
| Create visual output with generative models | [Image generation models](https://learn.microsoft.com/en-us/training/modules/get-started-vision-azure/3-image-generation) | [`docs/topics/computer-vision.md`](docs/topics/computer-vision.md); [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) explains generator expressions, Base64 decoding, and binary file contexts |
| Build a lightweight application with vision capabilities | [Exercise](https://learn.microsoft.com/en-us/training/modules/get-started-vision-azure/5-exercise) | [`docs/topics/computer-vision.md`](docs/topics/computer-vision.md) includes image-input and generation client flows; [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) provides cross-cutting code recognition |
...
- [**Information extraction and Content Understanding — complete**](research/gaps/information-extraction-content-understanding.md)
- [**Python SDK recognition for a C# developer — complete and cross-cutting**](research/gaps/python-sdk-recognition-csharp-developer.md)
...
| Build a lightweight Content Understanding application | [Exercise](https://learn.microsoft.com/en-us/training/modules/get-started-information-extraction/4-exercise) | [`docs/topics/information-extraction.md`](docs/topics/information-extraction.md) includes the asynchronous SDK flow; [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) distinguishes pollers, typed results, and true coroutines |
...
| Endpoints, keys, Entra ID, and clients | [Using Microsoft Foundry endpoints](https://learn.microsoft.com/en-us/training/modules/get-started-with-ai-in-azure/5-endpoints) | [`docs/topics/foundry-foundation.md`](docs/topics/foundry-foundation.md) for endpoint and authentication foundations; [`docs/topics/foundry-sdk-chat-agent-clients.md`](docs/topics/foundry-sdk-chat-agent-clients.md) for current client construction and request/response flow; [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) for shared Python syntax |
...
| 9 | Foundry SDK chat and agent clients | Chat client and agent client | **Complete** | [`research/gaps/foundry-sdk-chat-agent-clients.md`](research/gaps/foundry-sdk-chat-agent-clients.md) · [`docs/topics/foundry-sdk-chat-agent-clients.md`](docs/topics/foundry-sdk-chat-agent-clients.md) |
| 10 | Python SDK recognition for a C# developer | Cross-cutting code recognition | **Complete** | [`research/gaps/python-sdk-recognition-csharp-developer.md`](research/gaps/python-sdk-recognition-csharp-developer.md) · [`docs/topics/python-sdk-recognition-csharp-developer.md`](docs/topics/python-sdk-recognition-csharp-developer.md) |
