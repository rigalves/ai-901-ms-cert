...
| 2 | [Introduction to generative AI and agents](https://learn.microsoft.com/en-us/training/modules/fundamentals-generative-ai/) | LLMs, prompts, agents | [`docs/topics/responsible-ai-model-concepts.md`](docs/topics/responsible-ai-model-concepts.md) for LLM mechanics; [`docs/topics/generative-ai-prompts-model-configuration.md`](docs/topics/generative-ai-prompts-model-configuration.md) for prompt and model-selection review | [Model-mechanics gap complete](research/gaps/responsible-ai-model-concepts.md); [generative/prompt gap complete](research/gaps/generative-ai-prompts-model-configuration.md); agent gap pending | **Completed** |
...
| 2 | [Get started with generative AI and agents in Azure](https://learn.microsoft.com/en-us/training/modules/get-started-with-generative-ai-and-agents/) | Model selection/deployment, prompts, chat client, agent portal/client | [`docs/topics/generative-ai-prompts-model-configuration.md`](docs/topics/generative-ai-prompts-model-configuration.md) for model selection, deployment/configuration, prompts, and portal workflow; agent/client assets pending | [Generative/prompt gap complete](research/gaps/generative-ai-prompts-model-configuration.md); agent, Foundry SDK, and Python gaps pending | **Not started** |
