...
| Create a lightweight client application for an agent | [Creating an agent](https://learn.microsoft.com/en-us/training/modules/get-started-with-generative-ai-and-agents/4-creating-an-agent) | [`docs/topics/foundry-sdk-chat-agent-clients.md`](docs/topics/foundry-sdk-chat-agent-clients.md) includes persisted-agent invocation, conversation handling, Python/C# mappings, and code-recognition practice |
